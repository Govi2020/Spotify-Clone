...
export const shazamCoreApi = createApi({
    ...
    endpoints: (builder) => ({
        getTopCharts: builder.query({query: () => (`/charts/world?country_code=${countrycode}`)}),
        getSongsByGenre: builder.query({query: (({genreListId}) => (`/charts/genre-world?genre_code=${genreListId.toUpperCase()}&country_code=${countrycode}`))}),
